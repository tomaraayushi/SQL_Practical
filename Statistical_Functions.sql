...
FROM 'D:\SQL_practice\practical-sql-2-main\Chapter_11\acs_2014_2018_stats.csv'
...
FROM 'D:\SQL_practice\practical-sql-2-main\Chapter_11\cbp_naics_72_establishments.csv'
WITH (FORMAT CSV, HEADER);

SELECT * FROM cbp_naics_72_establishments
...
CREATE TABLE us_exports(
	...
	soybeans_exports_value bigint
);

COPY us_exports
FROM 'D:\SQL_practice\practical-sql-2-main\Chapter_11\us_exports.csv'
WITH (FORMAT CSV, HEADER);
